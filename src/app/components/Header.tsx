  ...
  return (
    <div className='bg-bgFooter relative z-[1000]'>
      <div className="h-20 bg-bgFooter justify-between xl:flex place-items-center max-w-screen-2xl m-auto">
        ...
        <ul className={`xl:inline-flex bg-bgFooter p-3 max-sm:flex max-sm:flex-col gap-4  md:gap-8 md:mr-28 text-xl font-roboto-medium md:items-center drop-shadow-md  ${openMenu ? 'top-15 opacity-100 w-screen text-right py-4 z-[1000] pl-4' : ' hidden'} md:opacity-100 opacity-0`}>
