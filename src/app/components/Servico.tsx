...
export const NossoServico = () => {
    ...
    return (
        <div className="bg-bgServico w-screen flex justify-center items-center xl:h-[544px]">
            <div>
                <div className="container mx-auto pt-8 flex flex-col justify-center w-screen p-8  ">
                    ...
                    <div className="xl:flex justify-around items-center gap-16 mt-4">
                        {servico.map(item => (
                            <ul key={item.id} className="">
                                ...
                                <li className="text-BlueDark text-[16px]  font-bold xl:ml-8 w-[320px] ">{item.text}</li>
                            </ul>
                        ))}
