...
const Escolha = () => {
  return (
    <div className='lg:w-screen'>
        ...
        <div className=' bg-bgColaborador max-lg:flex lg:justify-center lg:items-center lg:w-full'>
        <ul className=' bg-bgColaborador xl:flex md:grid md:grid-cols-2 md:justify-center flex justify-center items-center w-screen md:w-screen lg:items-center  self-center max-md:flex-col max-md:justify-center max-md:items-center max-w-7xl mt-[60px] gap-[76px] m-auto text-center max-sm:my-4'>
